...
array of objects, a key, and a value and returns the array passed 
...
the vowel appears in the string. This function should be 
...
new array with all the values in the array passed 
...
and returns a new array with each value 
multiplied by the index it 
s currently at in the array.
Examples:
...
some key and returns a new array with the value of 
...
and returns a new array with the value of the 
key with a name of "first" and the value of a key with the name 
...
a key and returns a new array with all 
the objects that contain that key.
Examples:
...
and some value to search for and returns the first 
